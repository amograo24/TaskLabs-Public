...
document.querySelector('#upload-form').addEventListener("submit",async function(e) {
  ...
  pyodide.runPython(`
    ...
    download_location,not_converted=excel_to_json(convertable,orientation,'excel_to_json')
...
async function main() {
    ...
    pyodide.runPython(`
        ...
        def excel_to_json(files,orientation,folder_name):
                ...
                try:
                    ...
                    for sheet_name,sheet_data in df.items():
                        ...
                        with open(f'{path_without_extension+fuid}.json','w') as f:
                            f.write(sheet_data.to_json(orient=orientation))
