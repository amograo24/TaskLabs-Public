...
document.querySelector('#upload-form').addEventListener("submit",async function(e) {
  ...
  pyodide.runPython(`
    ...
    download_location,not_converted=json_to_excel(convertable,all_in_one,orientation,'json_to_excel')
    ...
    if not_converted:
      ...
      for i in not_converted:
          ...
          li.innerHTML=f'{i}'
          ul.appendChild(li)
      h4=js.document.createElement("h4")
      h4.innerHTML="Please check the file format or the orientation type of the JSON File"
      ul.appendChild(h4)
...
async function main() {
    ...
    pyodide.runPython(`
        ...
        def json_to_excel(files,all_in_one,orientation,folder_name):
