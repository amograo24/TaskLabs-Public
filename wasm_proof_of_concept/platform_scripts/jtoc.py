...
def main():
    ...
    download_location,not_converted=json_to_csv('json-to-csv',convertable,orientation)
...
def json_to_csv(folder_name,files,orientation):
    empty_root_folder()
    ...
    for file_name,bin_str in files:
        ...
        try:
            ...
            df.to_csv(f'{path_without_extension+fuid}.csv',index=False)
